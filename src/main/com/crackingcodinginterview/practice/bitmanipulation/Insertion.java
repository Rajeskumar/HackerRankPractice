 ...
 * of M. That is, if M=10011, you can assume that there are at least 5 bits between j and i. You would not, for example,
...
public class Insertion {
    ...
    public int insertMintoN (int m, int n, int i, int j){
        ...
        //Clears all bits between j and i which is mask variable;
        int x = ~0 << j;
        int y = ((1<<i) - 1);
        int mask = x|y;
